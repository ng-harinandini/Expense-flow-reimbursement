...
Revision ID: 0008_drop_departments
Revises: 0007_roles_and_employee_cleanup
Create Date: 2026-07-29

Renumbered from ``0005`` when this branch was merged into the T004 AI platform work — see the note
in ``0007_roles_and_employee_cleanup``. No AI table references ``departments``, ``employees`` or
``claims``, so dropping them after the AI migrations is schema-safe.
"""
...
revision: str = "0008_drop_departments"
down_revision: Union[str, None] = "0007_roles_and_employee_cleanup"
